                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-justified justify-content-center">
                                    ...
                                    <a href="{{ route('admin.makeDefaultLanguage', $translation->id) }}" class="btn btn-sm btn-dark ml-1 @if($translation->is_default) badge-success btn-success @endif" data-popup="tooltip" title="Make {{ $translation->language_name }} as Default Language" data-placement="bottom"> <i class="icon-checkmark4"></i> </a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
